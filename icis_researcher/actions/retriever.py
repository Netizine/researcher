...
def get_retriever(retriever):
    ...
    match retriever:
        case "google":
            from icis_researcher.retrievers import GoogleSearch

            retriever = GoogleSearch
        case "searx":
            from icis_researcher.retrievers import SearxSearch

            retriever = SearxSearch
        case "searchapi":
            from icis_researcher.retrievers import SearchApiSearch

            retriever = SearchApiSearch
        case "serpapi":
            from icis_researcher.retrievers import SerpApiSearch

            retriever = SerpApiSearch
        case "serper":
            from icis_researcher.retrievers import SerperSearch

            retriever = SerperSearch
        case "duckduckgo":
            from icis_researcher.retrievers import Duckduckgo

            retriever = Duckduckgo
        case "bing":
            from icis_researcher.retrievers import BingSearch

            retriever = BingSearch
        case "arxiv":
            from icis_researcher.retrievers import ArxivSearch

            retriever = ArxivSearch
        case "tavily":
            from icis_researcher.retrievers import TavilySearch

            retriever = TavilySearch
        case "exa":
            from icis_researcher.retrievers import ExaSearch

            retriever = ExaSearch
        case "semantic_scholar":
            from icis_researcher.retrievers import SemanticScholarSearch

            retriever = SemanticScholarSearch
        case "pubmed_central":
            from icis_researcher.retrievers import PubMedCentralSearch

            retriever = PubMedCentralSearch
        case "custom":
            from icis_researcher.retrievers import CustomRetriever
