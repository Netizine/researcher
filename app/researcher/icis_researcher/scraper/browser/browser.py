...
from app.researcher.icis_researcher.scraper.browser.processing.scrape_skills import (scrape_pdf_with_pymupdf,
...
from app.researcher.icis_researcher.scraper.utils import get_relevant_images, extract_title
