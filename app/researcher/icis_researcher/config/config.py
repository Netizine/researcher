...
from app.researcher.icis_researcher.variables.default import DEFAULT_CONFIG
from app.researcher.icis_researcher.variables.base import BaseConfig
from app.researcher.icis_researcher.retrievers.utils import get_all_retriever_names


class Config:
    """Config class for ICIS Researcher."""
    ...
    def parse_llm(llm_str: str | None) -> tuple[str | None, str | None]:
        ...
        from app.researcher.icis_researcher.llm_provider.generic.base import _SUPPORTED_PROVIDERS
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        from app.researcher.icis_researcher.memory.embeddings import _SUPPORTED_PROVIDERS
